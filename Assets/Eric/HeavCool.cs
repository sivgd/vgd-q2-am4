...
public class HeavCool : MonoBehaviour
{
    ...
    void Start()
    {
        cooldownmax = GameObject.Find("bigSnow(k)").GetComponent<BallThrow>().baseCooldown;
    ...
    void Update()
    {
        cooldown = GameObject.Find("bigSnow(k)").GetComponent<BallThrow>().cooldown;
        if (cooldown <= 0)
        {
